...
namespace DBPhoneInterface
{
    ...
    /// </summary>
    public sealed partial class FindAnswers : Page
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            switch(Subject.Text)
            {
                ...
                case "Data Structures & Algorithms":
                    ...
                    results = "You have selected to run the stored procedure for Data Structures and Algorithms Answers to Questions.";
                    break;
                case "Distributed Systems":
                    // Run stored procedure for DistrSystA table using given data.
                    results = "You have selected to run the stored procedure for Distributed Systems Answers to Questions.";
                    break;
                default:
